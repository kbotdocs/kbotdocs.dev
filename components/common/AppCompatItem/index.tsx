  ...
  return (
    <>
      <Tr {...p}>
        ...
        <Td
          className={`cursor-pointer md:hover:bg-default-hover ${(selected === "msgBot") ? "md:border-b-emphasis md:border-b-[2px]" : ""}`}
          onClick={() => trOnClickHandler("msgBot", compat.support.msgBot)}>
          <div className={`flex items-center gap-[8px] h-full`}>
            ...
            <div>
              <DetailedStatusIcon
                detailedStatus={compat.support.msgBot[compat.support.msgBot.length - 1].detailedStatus}
                seeHistory={(compat.support.msgBot.length > 1)}/>
            </div>
          </div>
          {
        ...
        <Td
          className={`cursor-pointer md:hover:bg-default-hover ${(selected === "autoReplyBot") ? "md:border-b-emphasis md:border-b-[2px]" : ""}`}
          onClick={() => trOnClickHandler("autoReplyBot", compat.support.autoReplyBot)}>
          <div className={`flex items-center gap-[8px] h-full`}>
            ...
            <div>
              <DetailedStatusIcon
                detailedStatus={compat.support.autoReplyBot[compat.support.autoReplyBot.length - 1].detailedStatus}
                seeHistory={(compat.support.autoReplyBot.length > 1)}/>
            </div>
          </div>
          {
        ...
        <Td
          className={`cursor-pointer md:hover:bg-default-hover ${(selected === "starLight") ? "md:border-b-emphasis md:border-b-[2px]" : ""}`}
          onClick={() => trOnClickHandler("starLight", compat.support.starLight)}>
          <div className={`flex items-center gap-[8px] h-full`}>
            ...
            <div>
              <DetailedStatusIcon
                detailedStatus={compat.support.starLight[compat.support.starLight.length - 1].detailedStatus}
                seeHistory={(compat.support.starLight.length > 1)}/>
            </div>
          </div>
          {
