...
export default function AppCompatibilityHistory({ history }: IAppCompatibilityHistory) {
    return (
        <div className={
            ...
            "before:content-[''] before:absolute before:z-[-1] before:top-[calc(1rem/2)] before:left-[calc(1rem/2-1px)] before:w-[2px] before:h-[calc(100%-1rem)] before:bg-[theme(borderColor.default)] " +
