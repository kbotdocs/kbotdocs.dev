                                ...
                                children: [
                                    {
                                        ...
                                        children: [
                                            ...
                                            {
                                                label: "getActiveThreadsCount()",
                                                path: "/legacy/Api/getActiveThreadsCount"
                                            },
                                            ...
                                            {label: "markAsRead()", path: "/legacy/Api/markAsRead"},
                                            {
                                                ...
                                                path: "/legacy/Api/markAsReadOnID(BigInt)"
                                            },
                                            {
                                                label: "markAsReadOnID(String)",
                                                path: "/legacy/Api/markAsReadOnID(String)"
                                            },
                                ...
                                children: [
                                    {
                                        ...
                                        children: [
                                            {label: "acquireWakeLock()", path: "/legacy/Device/acquireWakeLock"},
                                            {
                                                ...
                                                path: "/legacy/Device/getAndroidVersionCode"
                                            },
                                            {
                                                label: "getAndroidVersionName()",
                                                path: "/legacy/Device/getAndroidVersionName"
                                            },
                                            ...
                                            {label: "getBatteryTemp()", path: "/legacy/Device/getBatteryTemp"},
                                            {
                                                ...
                                                path: "/legacy/Device/getBatteryTemperature"
                                            },
                                            ...
                                            {label: "getBuild()", path: "/legacy/Device/getBuild"},
                                            {
                                                ...
                                                path: "/legacy/Device/getConnectedNetworkType"
                                            },
                                            {label: "getFreeMemory()", path: "/legacy/Device/getFreeMemory"},
                                            {
                                                label: "getFreeStorageSpace()",
                                                path: "/legacy/Device/getFreeStorageSpace"
                                            },
                                            ...
                                            {label: "getTotalMemory()", path: "/legacy/Device/getTotalMemory"},
                                            {
                                                ...
                                                path: "/legacy/Device/getTotalStorageSpace"
                                            },
                                ...
                                children: [
                                    {
                                        ...
                                        children: [
                                            ...
                                            {
                                                label: "getAndroidVersionCode()",
                                                path: "/legacy/Utils/getAndroidVersionCode"
                                            },
                                            {
                                                label: "getAndroidVersionName()",
                                                path: "/legacy/Utils/getAndroidVersionName"
                                            },
                            ...
                            },
                            {
                                ...
                                children: [
                                    ...
                                    {label: "reply(String)", path: "/legacy/Replier/reply(String)"},
                                    {
                                        ...
                                        path: "/legacy/Replier/reply(String,String,Boolean$)"
                                    },
                                    {
                                        label: "replyDelayed(String, Number)",
                                        path: "/legacy/Replier/replyDelayed(String,Number)"
                                    },
                                    {
                                        label: "replyDelayed(String, String, Number, Boolean?)",
                                        path: "/legacy/Replier/replyDelayed(String,String,Number,Boolean$)"
                                    },
                                ]
                            },
                            {
                                        ...
                                        children: [
                                            {
                                                ...
                                                path: "/legacy/SessionManager/bindSession(String,Action$)"
                                            },
                                            {
                                                label: "bindSession(String, String, android.app.Notification.Action?)",
                                                path: "/legacy/SessionManager/bindSession(String,String,Action$)"
                                            },
                                        ]
                                    }
                                ]
                                ...
                                children: [
                                    {
                                        ...
                                        children: [
                                            ...
                                            {label: "prepare(Boolean?)", path: "/api2/BotManager/prepare(Boolean$)"},
                                            {
                                                ...
                                                path: "/api2/BotManager/prepare(String,Boolean$)"
                                            },
                                ...
                                children: [
                                    {
                                        ...
                                        children: [
                                            ...
                                            {
                                                label: "getAndroidVersionCode()",
                                                path: "/api2/Device/getAndroidVersionCode"
                                            },
                                            {
                                                label: "getAndroidVersionName()",
                                                path: "/api2/Device/getAndroidVersionName"
                                            },
                                            ...
                                            {
                                                label: "getTotalStorageSpace()",
                                                path: "/api2/Device/getTotalStorageSpace"
                                            },
                                        ...
                                        children: [
                                            {
                                                ...
                                                path: "/api2/Http/request(Object,Function)"
                                            },
                                            {
                                                label: "request(String, Function)",
                                                path: "/api2/Http/request(String,Function)"
                                            },
                        ...
                        children: [
                            ...
                            },
                            {
                                ...
                                children: [
                                    {
                                        label: "bindSession(String, android.app.Notification.Action?)",
                                        path: "/api2/SessionManager/bindSession(String,Action$)"
                                    },
                                    {
                                        label: "bindSession(String, String, android.app.Notification.Action?)",
                                        path: "/api2/SessionManager/bindSession(String,String,Action$)"
                                    },
                                ]
                            },
                        ]
                                    ...
                                    },
                                    {
                                        ...
                                        children: [
                                            {label: "getAsset()", path: "/starlight/Plugin/getAsset"},
                                            {
                                                ...
                                                path: "/starlight/Plugin/getExternalDataDirectory"
                                            },
                                            {
                                                label: "getInternalDataDirectory()",
                                                path: "/starlight/Plugin/getInternalDataDirectory"
                                            },
                                    ...
                                    },
                                    {
                                        ...
                                        children: [
                                            ...
                                            {label: "getScope()", path: "/starlight/Project/getScope"},
                                            {
                                                ...
                                                path: "/starlight/Project/isEventCallAllowed"
                                            },
